...
foreach ($pagos as $reporteactual) {
    ...
    foreach ($pagos as $pagoactual) {
        ...
        if ($idestadodir != "0") {
            $estadodir = $cf->getEstadoAux($idestadodir);
        }
    ...
    $pdf->SetX(10);
    $pdf->RowNBCount(Array('', utf8_decode($calleemisor . ' #' . $numemisor . ', Colonia: ' . $colemisor . ', ' . $munemisor . ', ' . $estadoemisor)));
    ...
    $pdf->SetTextColor($rgbtxt[0], $rgbtxt[1], $rgbtxt[2]);
    $pdf->SetX(10);
    $pdf->RowNB(Array('', utf8_decode($calleemisor . ' #' . $numemisor . ', Colonia: ' . $colemisor . ', ' . $munemisor . ', ' . $estadoemisor)));
    ...
    $pdf->SetLineHeight(4.5);
    $pdf->SetX(10);
    $pdf->RowNBCount(Array('Direccion', utf8_decode($calle . ' #' . $num . ', Colonia: ' . $col . ', ' . $municipio . ', ' . $estadodir)));
    ...
    $pdf->SetTextColor($rgbtxt[0], $rgbtxt[1], $rgbtxt[2]);
    $pdf->SetX(10);
    $pdf->RowNB(Array('', utf8_decode($calle . ' #' . $num . ', Colonia: ' . $col . ', ' . $municipio . ', ' . $estadodir)));
    ...
    $pdf->RowNBC(Array(utf8_decode('UUID'), utf8_decode('FOLIO'), utf8_decode('METODO PAGO'), utf8_decode('TOTAL FACTURA'), utf8_decode('MONEDA/CAMBIO'), utf8_decode('PARCIALIDAD'), utf8_decode('ANTERIOR'), utf8_decode('PAGADO'), utf8_decode('RESTANTE')));
