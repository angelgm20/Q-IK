...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $encabezado = $cc->getDatosEncabezado('10');
...
$divide3 = explode("-", $fechainicio);
$divide2 = explode("-", $fechafin);
$fechainicio = $divide3[2] . '/' . $divide3[1] . '/' . $divide3[0];
$fechafin = $divide2[2] . '/' . $divide2[1] . '/' . $divide2[0];
...
$pdf->SetLineHeight(6);
$pdf->RowR(Array('Del ' . $fechainicio . ' al ' . $fechafin));
$pdf->Ln(4);
