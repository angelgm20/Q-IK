            ...
            <div class="modal-body">
                <form class="form-horizontal" onsubmit="return false;">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <select class="form-select w-100 p-2 mb-3" id="num-reg" name="num-reg" onchange="buscarProducto()">
                ...
                <div class="row scroll-modal scrollX" id="datosproducto" >
                    <table class=" table table-hover  table-condensed table-responsive table-row thead-mod" id="body-lista-productos-factura">
